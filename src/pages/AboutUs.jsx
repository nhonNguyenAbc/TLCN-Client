      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            Welcome to [Website Name] – Your Simple and Quick Restaurant
            Reservation Solution!
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            At [Website Name], we understand that finding and reserving a table
            at your favorite restaurant can be time-consuming and cumbersome.
            That’s why we’ve developed an easy-to-use online platform that saves
            you time and ensures a delightful dining experience.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <img
